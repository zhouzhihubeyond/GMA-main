...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='gma-sintel', help="name your experiment")
    ...
    parser.add_argument('--restore_ckpt', default='checkpoints/gma-sintel.pth',help="restore checkpoint")
    parser.add_argument('--output', default='results/sintel/gma',type=str, help='output directory to save checkpoints and plots')
